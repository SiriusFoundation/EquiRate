...
% path belirlendi
m_path = strcat('../out/10_one_metric/',m_dataset_name,'/',m_dataset_name,'_all.csv');
m_save_path = strcat('../out/10_one_metric/','one_metric_all.xlsx');
...
% gereksiz saıtlar, case'ler silindi
m_Data_Set(m_Data_Set.alpha==0.33,:)=[];
m_Data_Set(m_Data_Set.alpha==0.25,:)=[];
m_Data_Set(m_Data_Set.alpha==0.67,:)=[];
m_Data_Set(m_Data_Set.alpha==0.75,:)=[];
m_Data_Set(m_Data_Set.alpha==1,:)=[];

m_Data_Set(ismember(m_Data_Set.algorithm,'all'),:)=[];
m_Data_Set(ismember(m_Data_Set.algorithm,'usr'),:)=[];
m_Data_Set(ismember(m_Data_Set.algorithm,'S2B5N'),:)=[];
m_Data_Set(ismember(m_Data_Set.algorithm,'S4B25N'),:)=[];

m_Data_Set(ismember(m_Data_Set.prediction,'HPF'),:)=[];
m_Data_Set(ismember(m_Data_Set.prediction,'SKM'),:)=[];
m_Data_Set(ismember(m_Data_Set.prediction,'MMMF'),:)=[];
m_Data_Set(ismember(m_Data_Set.prediction,'VAECF'),:)=[];
