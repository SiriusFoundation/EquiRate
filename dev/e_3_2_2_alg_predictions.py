...
# burada csv uzantılı vektor formatında veri, aşağıdaki algoritmaya sokulup prediction yapılıyor
...
print("e_3_2_2_alg_predictions started!")

def getTime(): return datetime.datetime.now().strftime("%Y/%m/%d %H:%M:%S")

predictionCalculationFlag = True

sourceFilePath = '../out/3_2_1_algorithm_approach_convert_csv/'

exportFilePath = '../out/3_2_2_algorithm_approach_predict_with_algoritm/'
...
print("e_3_2_2_alg_predictions finished!")
