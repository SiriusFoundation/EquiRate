# e_8_1_other_debiasing_predictions
# 	pythonda predictiona sok
# 	csv vector al
# 	prediction ver
...
print("e_7_basic_predictions parallel 4 started!")

def getTime(): return datetime.datetime.now().strftime("%Y/%m/%d %H:%M:%S")

predictionCalculationFlag = True

sourceFilePath = '../out/8_1_other_debiasing_predictions/'
exportFilePath = '../out/8_2_apply_other_debiasing/'
...
print("e_7_basic_predictions parallel 4 finished!")
