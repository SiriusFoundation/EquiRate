...
for dataSetCounter=1:size(data_set_collection,2)
                ...
                for distributionCounter=1:size(distribution_collection,2)
                    ...
                    if ((active_sigmamax == 0 && active_betamax == 0 && active_distribution == "N") || (active_sigmamax == 2 && active_betamax == 5 && active_distribution == "N") || (active_sigmamax == 3 && active_betamax == 10 && active_distribution == "N") || (active_sigmamax == 4 && active_betamax == 25 && active_distribution == "N"))
                        ...
                        for repeatCounter=1:repeat_collection
                            ...
                            sum_Novelity = sum_Novelity + m_DataSet_SubSet_as_Cell{repeatCounter,19};
                        ...
                        sum_F1 = sum_F1 / 5;
                        sum_APLT = sum_APLT / 5;
                        sum_Novelity = sum_Novelity / 5;
                        sum_LTC = sum_LTC / 5;
                        sum_Entropy = sum_Entropy / 5;
                        
                        % disp("date" + ";" + "counter" + ";" + "filename" + ";" + "dataset" + ";" + "sigma" + ";" + "beta" + ";"  + "dist" + ";" + "randomize" + ";" + "algorithm" + ";" + "GAPp" + ";" + "GAPr" + ";" + "DeltaGAP_IM" + ";" + "DeltaGAP_MA" + ";" + "NCDG" + ";" + "Precision" + ";" + "Recall" + ";" + "F1" + ";" + "APLT" + ";" + "Novelity" + ";" + "LTC" + ";" + "Entropy");
                        ...
                        m_export_cell{m_export_row_count,19} = sum_Novelity;
    ...
    % buraya kaydet
    m_table_header = {'date', 'counter', 'filename', 'dataset', 'sigma', 'beta', 'dist', 'randomize', 'algorithm', 'GAPp', 'GAPr', 'DeltaGAP_IM', 'DeltaGAP_MA', 'NCDG', 'Precision', 'Recall', 'F1', 'APLT', 'Novelity', 'LTC', 'Entropy'};
